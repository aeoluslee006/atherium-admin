...
export default function AtheriumNavRail({ children, userEmail = 'Admin', activeView = 'calendar', onNavigate }) {
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 0 }}>
        ...
        <div style={{
          ...
          <AtheriumBottomNav compact activeView={activeView} onNavigate={onNavigate} />
