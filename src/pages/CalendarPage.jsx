...
export default function CalendarPage({ userEmail = 'Admin', view = 'calendar', onNavigate }) {
  const activeView = view === "stickers" ? "stickers" : "calendar";
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: THEME.bg, color: THEME.text, fontFamily: "'Outfit', sans-serif", overflow: "hidden", fontSize: 12 }}>
      <AtheriumNavRail userEmail={userEmail} activeView={activeView} onNavigate={onNavigate}>
